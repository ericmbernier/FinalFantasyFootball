...
- [League Governence](#section-i---league-governence)
   ...
   - [End of Year Voting / Passing A Rule](#end-of-year-voting)
   - [Collusion](#collusion)
   - [Tanking](#tanking)
...
### Entry Fee ###
- The entry fee for the league is $30 per season, with two seasons required upfront. 
...
- Payment must be paid at minimum a month before the rookie draft. 
...
- Each team will receive $100 for a Free Agent Aquisition Budget
...
- Picks 6-10 will be assigned in inverse order of the postseason standings
...
- The two teams with the best regular season records will be assigned to the top two seeds, and receive a first round bye. There are NO divisions in this league.
- The next three teams will be assigned their playoff seeding spot based on regular season record.
- The sixth seed is the last remaining team with the MOST points scored during the regular season.
...
### Leaving the League ###
- In the event that you wish to quit the league, you must let the league know upon completion of the current season. Life happens, play out the season you paid up for, and let's all move on quickly. The sooner the league knows the easier it is to find a replacement owner, and the sooner things can go back to normal. 
- If you are not willing to play out the current season, you forfeit the money that you have paid, and the commissioner will make all of your start/sit decisions based on Sleeper's highest projections. No trades will be made, nor free agent signings. 
